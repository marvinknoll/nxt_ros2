...
def generate_launch_description():
    ...
    # model:='absolute/path/to/config/file.urdf.xacro'
    ...
    # Use custom rviz config file with: ros2 launch nxt_ros2 default.launch.py
    # rviz_config:='absolute/path/to/config/file.rviz'
    rviz_config_arg = DeclareLaunchArgument(
        name="rviz_config",
        default_value=str(base_robot_rviz_config_path),
    ...
    odometry_node = Node(
        package="nxt_ros2", output="screen", executable="odometry"
    )
